...
const totalAmountOfGoodsInCart = document.getElementById("totalAmountOfGoodsInCart");
...
const imagesFilePath = [	"images/image-product-1.jpg","images/image-product-2.jpg","images/image-product-3.jpg","images/image-product-4.jpg"];
let indx = 1;
...
//FUNCTION FOR NEXT IMAGE VIEW ON MOBILE.
  function nxt(){
  		...
  		else	if(window.innerWidth>=767){	lightboxContents.children[1].children[0].children[0].src =	imagesFilePath[indx];
  					}
...
let chk =  lightboxContents.children[1].children[0].children[0].src=e.target.src;
 }
  ...
  if(window.innerWidth>=767){
	...
	lightboxContents.appendChild(cloneN);
     ...
     lightboxContents.children[1].children[0].children[0].src=imagesFilePath[0];
